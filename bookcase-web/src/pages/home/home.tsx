          ...
          <g id="首页" transform="translate(-68.000000, -88.000000)">
            <g id="Illustrator" transform="translate(68.000000, 88.000000)">
              <g id="i5" transform="translate(511.000000, 79.000000)">
                ...
                <TweenOne component="g" animation={{ ...animate.loop, y: -5, delay: duration + 200 }}>
                  ...
                  <TweenOne component="g" animation={{ delay, ...animate.y }} id="Group-25" transform="translate(56.000000, 29.000000)">
                    ...
                    <polyline id="Path-27" points="19 7.94896696 70.1627859 0 70.1627859 16.1721413 125.493456 10.2888698 125.493456 32 182 26.2385985"></polyline>
              ...
              <g id="i2" transform="translate(338.000000, 172.000000)">
                ...
                <TweenOne component="g" animation={{ ...animate.loop, y: 10, delay: delay + duration + 200 }}>
                  <TweenOne component="g" animation={{ delay: delay, ...animate.yBig }}>
                  ...
                  <TweenOne component="g" animation={{ delay: delay + 500, ...animate.alpha }} id="Group-20" transform="translate(62.000000, 72.000000)">
                    <polyline id="Line-5" stroke="#11D373" strokeWidth="4" strokeLinecap="square" points="11.9264069 6.94366197 62.0995671 9.3943662 122.570177 21.7085167 178.973214 14.3260893"></polyline>
                  ...
                  <TweenOne component="g" animation={{ delay: delay + 300, ...animate.y }} id="Group" transform="translate(62.000000, 57.000000)">
                    <g id="Group-20" transform="translate(0.000000, 3.000000)">
                      <polyline id="Line-5" stroke="#EEEFF2" strokeWidth="4" strokeLinecap="square" points="11.9264069 6.94366197 62.0995671 9.3943662 122.570177 21.7085167 178.973214 14.3260893"></polyline>
                    ...
                    <g id="Group-20">
                      <polyline id="Line-5" stroke="#FFFFFF" strokeWidth="4" strokeLinecap="square" points="11.9264069 6.94366197 62.0995671 9.3943662 122.570177 21.7085167 178.973214 14.3260893"></polyline>
              ...
              <g id="i1" transform="translate(42.000000, 248.000000)">
                ...
                <TweenOne component="g" animation={{ ...animate.loop, y: 15, delay: delay + duration + 200 }}>
                  <TweenOne component="g" animation={{ delay: delay, ...animate.yBig }} id="Group-21" transform="translate(3.000000, 0.000000)">
              ...
              <g id="bin" transform="translate(350.000000, 355.000000)">
                ...
                <TweenOne component="g" animation={[{ delay: delay, ...animate.yBig }, { delay: 200, ...animate.loop, y: 20 }]} id="Group-23">
