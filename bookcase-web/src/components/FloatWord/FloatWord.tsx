/*
此组建参考https://github.com/dragonir/3d/tree/master/src/containers/Floating
*/
...
export default class Earth extends React.Component {
  ...
  initThree = () => {
    ...
    //helvetiker_regular.typeface.json需要放在public，路径则如下，否则无法加载
    loader.load('./fonts/helvetiker_regular.typeface.json', font => {
      textMesh.geometry = new TextGeometry('BOOKCASE\nhappy\nfun\nvivid', {
        font: font,
        size: 100,
        height: 40,
        curveSegments: 12,
